...
#define RENDER_CONFIG_PLAY_STATE_PULSE_START_DIM 32
#define RENDER_CONFIG_PLAY_STATE_PULSE_SLOWDOWN 4

#define RENDER_CONFIG_PLAY_STATE_COLOR_DIM 127
#define RENDER_CONFIG_PLAY_STATE_SELECT_TARGET_COLOR_DIM 63
